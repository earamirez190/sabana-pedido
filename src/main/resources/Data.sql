...
-- COMPRA
INSERT INTO pedidos VALUES (1, '4546221', TO_TIMESTAMP('10/08/1992 17:30:00','DD/MM/YYYY HH24:MI:SS'), 'E', '', 'P');
INSERT INTO pedidos_productos VALUES (1, 1, 10, 3000, true);
INSERT INTO pedidos_productos VALUES (1, 36, 1, 40000, true);
INSERT INTO pedidos_productos VALUES (1, 27, 1, 9000, true);
INSERT INTO pedidos_productos VALUES (1, 49, 2, 16400, true);
INSERT INTO pedidos_productos VALUES (1, 24, 1, 4000, true);
...
SELECT setval('public.pedidos_id_pedido_seq', 1, true);
